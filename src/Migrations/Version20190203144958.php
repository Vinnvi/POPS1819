 ...
 */
final class Version20190203144958 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, chef_id INT NOT NULL, nom VARCHAR(1024) NOT NULL, INDEX IDX_E19D9AD2150A48F1 (chef_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE collaborateur_service DROP FOREIGN KEY FK_C6A2D320ED5CA9E6');

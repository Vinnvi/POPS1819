...
final class Version20190213165003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE background_pic_path (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profile_page (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE collaborateur ADD background_pic_path VARCHAR(1024) DEFAULT NULL, CHANGE email email VARCHAR(1024) NOT NULL, CHANGE salt salt VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE notification ADD personnel TINYINT(1) NOT NULL, ADD cumulable TINYINT(1) NOT NULL, ADD vu TINYINT(1) NOT NULL');
    }

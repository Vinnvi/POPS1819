 ...
 */
final class Version20190227153206 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_de_frais /*DROP demande_avance_id, */CHANGE justificatif justificatif LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_de_frais ADD demande_avance_id INT DEFAULT NULL, CHANGE justificatif justificatif VARCHAR(512) DEFAULT NULL COLLATE utf8mb4_unicode_ci');

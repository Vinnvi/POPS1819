 ...
 */
final class Version20190304172152 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_de_frais ADD montant_avance DOUBLE PRECISION DEFAULT NULL/*, DROP demande_avance_id*/');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ligne_de_frais ADD demande_avance_id INT DEFAULT NULL, DROP montant_avance');
